...
//        return json_decode($reply, true);
    ...
    {
        $requestBody = $certificate === '' ? ['url' => $url] : ['url' => $url, 'certificate' => "@$certificate"];
    ...
    {
        return  ($this->data['message']['chat']['type'] !== 'private') ?$this->data['message']['chat']['title']:false;
    }
     ...
     * @param null $switch_inline_query
     * @param null $switch_inline_query_current_chat
     * @param string $callback_game
     * @param string $pay
     * @return array
     */
    public function buildInlineKeyboardButton($text, $url = '', $callback_data = '', $switch_inline_query = null, $switch_inline_query_current_chat = null, $callback_game = '', $pay = ''): array
    {
        $replyMarkup = [
            'text' => $text,
        ];
    ...
    public function getUpdates($offset = 0, $limit = 100, $timeout = 0, $update = true)
    {
        ...
        if ($update && count($this->updates['result']) >= 1) { //for CLI working.
