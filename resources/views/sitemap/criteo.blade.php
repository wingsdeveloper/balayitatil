...
<rss xmlns:g="http://base.google.com/ns/1.0" version="2.0">
   <channel>
        ...
        <link>https://www.villakalkan.com.tr</link>
        <description>Villa Kalkan</description>
   ...
   @endif
	<item>
			...
			$pricesmin = App\villaPrice::select("daily_price_tl")->where('villa_id', $row->panel_villa->villa_id)->where("daily_price_tl", ">", 0)->whereDate('end_date', '>', Carbon\Carbon::now())->whereNotNull("start_date")->whereNotNull("end_date")->orderByRaw($orderbyraw)->first();
	     ...
	     <g:title>{{ Transliterator::create('tr-title')->transliterate($villa->name) }}</g:title>
		 ...
		 <g:price>{{ ceil(number_format($gune_ait_fiyat, 2, '.', '') ) }}</g:price>
	      <g:description>{{$row->number_person}} Kişilik Villa </g:description>
