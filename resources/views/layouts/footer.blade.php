                ...
                <div class="Ayin-villasi">
                    <a href="{{ url($seo->seo_url) }}">
                        <div class="Ayin-villasi-img">
                            <img src="{{ ImageProcess::getImageByPath('uploads/villa/gallery/' . $month->list_image . '/' . $month->list_image_name) }}" alt="Balayı Sepeti - Ayın Villası" width="470" height="313">
...
<!--
        ...
        <img class="Navbottom-menu-back" width="1400" height="160" src="{{ asset('images/footer-back.svg') }}" alt="Footer Background Shape">
        <img class="Navbottom-menu-back-m" width="375" height="105" src="{{ asset('images/footer-back-mobile.svg') }}" alt="Footer Background Shape">
    </div>
</div>
...
<div class="Navbottom-banks ">
    <div class="container containerindex">
        <div class="Navbottom-banks-in">
            <img src="{{ asset('images/banks.svg') }}" width="520" height="16" alt="Çalıştığımız Bankalar" class="bank">
            <img src="{{ asset('images/banks-mobile.svg') }}" width="322" height="59" alt="Çalıştığımız Bankalar" class="bank-m">
            <img src="{{ asset('images/guvenli-odeme.svg') }}" width="150" height="30" alt="Güvenli Ödeme" class="guvenli-odeme">
        </div>
    </div>
</div>
