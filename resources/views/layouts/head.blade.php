...
@endphp
    ...
    <link rel="stylesheet" href="{{ asset('css/library/global.css?v=1.28vk') }}">
    <link rel="stylesheet" href="{{ asset('css/main.css?v=1.28vk') }}">
    <link rel="stylesheet" href="{{ asset('css/library/theme-old.css?v=1.28vk') }}">
