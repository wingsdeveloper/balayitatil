                            ...
                            <div class="P_villas-info">
                                ...
                                <div class="P_villas-info-money">
                                    ...
                                    <div class="flex-column">
                                        <h6>{{ isset($villa->starting_price) ? number_format((float)$villa->starting_price, 0, ',', '.') : '' }} ₺</h6>
                                        <p>{{ isset($villa->list_price) ? number_format((float)$villa->list_price, 0, ',', '.') : '' }} </p>
                ...
                {{ $villa_mobile->number_person }} Kişilik
                                ...
                                <div class="P_villas-info-money">
                                    ...
                                    <div class="flex-column">
                                        ...
                                        <p>{{number_format((float)$villa_mobile->list_price, 0, ',', '.')}}₺</p>
                                        <span>ARALIĞINDA</span>
                                    </div>
                                </div>
                            </div>
